...
if (!ADMIN_EMAIL || !ADMIN_ACCESS_KEY_HASH) {
  console.error('❌ Missing environment variables!');
  console.error('Please set ADMIN_EMAIL and ADMIN_ACCESS_KEY_HASH in .env file');
  process.exit(1);
}
...
console.log('   - Access Key: [enter the raw key, not the hash]');

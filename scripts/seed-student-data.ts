...
// Sample data
const COURSES = [
  { slug: 'plan-1', name: 'Adyapan Starter', totalLessons: 14 },
  { slug: 'plan-2', name: 'Adyapan Standard', totalLessons: 18 },
  { slug: 'plan-3', name: 'Adyapan Professional', totalLessons: 22 },
  { slug: 'plan-4-premium', name: 'Adyapan Career Pro', totalLessons: 28 },
];

const EDUCATION_LEVELS = ['B.Tech', 'M.Tech', 'B.Sc', 'MCA', 'MBA', 'BCA'];

const SAMPLE_STUDENTS = [
  { name: 'Rupesh Kumar', email: 'rupesh.rupak@example.com', phone: '8179124566', education: 'B.Tech' },
...
async function seedStudentData() {
  try {
    ...
    const defaultPassword = await argon2.hash('Test@123', {

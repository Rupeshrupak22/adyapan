...
// Set ADMIN_LOGIN_EMAIL, ADMIN_PASS, and ADMIN_NAME in your .env before running this script.
const ADMIN_EMAIL  = process.env.ADMIN_LOGIN_EMAIL || process.env.ADMIN_EMAIL;
...
async function main() {
  ...
  if (existing) {
    ...
    console.log('   Password: [hidden]  (now hashed in DB)');

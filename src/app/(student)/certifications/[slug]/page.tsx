              ...
              <div className="relative rounded-xl overflow-hidden border-2 border-orange-100 shadow-lg mb-5">
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      parent.innerHTML = `<div class="flex flex-col items-center justify-center py-16 text-gray-400"><svg class="w-12 h-12 mb-3 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg><p class="text-sm font-medium">Certificate preview</p><p class="text-xs mt-1">Issued by ${company.name}</p></div>`;
                    }
                  }}
                />
                {/* SAMPLE watermark */}

      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <div className="text-2xl font-bold text-gray-900">Rs. 18K</div>
          </div>
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map((category) => (
                  <button
                    ...
                    className={`px-3 py-2 sm:py-1.5 rounded-lg text-sm font-medium transition-colors min-h-[44px] sm:min-h-0 ${
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    <div>
                      <div className="font-medium">Rs. {task.budget.toLocaleString()}</div>

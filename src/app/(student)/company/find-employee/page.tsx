...
interface Talent {
  ...
  photoUrl: string; email: string; phone: string; location: string; resumeUrl: string;
  ...
  if (photoUrl) {
    return (
      <img
        src={photoUrl}
        alt={name}
        className={`${sz} flex-shrink-0 rounded-2xl object-cover object-center shadow-lg ring-2 ring-white/70`}
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#ffa800] to-[#f97316] px-6 py-6 text-white">
          ...
          <div className="flex items-start gap-4">
            <Avatar name={talent.name} photoUrl={talent.photoUrl} size="lg" />
...
function TalentCard({
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <Avatar name={talent.name} photoUrl={talent.photoUrl} />
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="flex gap-6">
          ...
          <aside className="hidden w-56 flex-shrink-0 xl:block">
            ...
            <div className="mt-4 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
              ...
              <a href="tel:8179124566" className="flex items-center gap-2 text-sm font-bold text-orange-500 hover:underline">
                <Phone className="h-4 w-4" /> 8179124566
              </a>

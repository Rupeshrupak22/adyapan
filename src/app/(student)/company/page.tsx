...
export default function CompanyPage() {
  ...
  return (
    <div className='min-h-screen bg-white overflow-x-hidden'>
      ...
      </section>      <section className='py-10 sm:py-12 relative overflow-hidden border-y-4 border-orange-400' style={{background:'linear-gradient(135deg,#f97316,#ea580c,#f59e0b)'}}>
        <div
      ...
      <section className='py-16 sm:py-24 bg-white relative overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 relative z-10'>
          <div className='text-center mb-16'>
            ...
            <h2 className='text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mt-3 mb-4'>Why <span className='text-orange-500'>Adyapan</span> Talent?</h2>
      ...
      </section>      <section className='py-16 sm:py-24 relative overflow-hidden' style={{background:'linear-gradient(135deg,#0f172a,#1e1b4b,#0f172a)'}}>
        <div className='absolute inset-0 pointer-events-none'>
          {[...Array(6)].map((_,i) => (
            <div key={i}
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 relative z-10'>
          <div className='text-center mb-16'>
            ...
            <h2 className='text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mt-3 mb-4'>How It Works</h2>
      ...
      <section className='py-16 sm:py-24 bg-white relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10'>
          <div>
            ...
            <h2 className='text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mt-3 mb-4'>Ready to Hire <span className='text-orange-500'>Job-Ready Talent?</span></h2>
